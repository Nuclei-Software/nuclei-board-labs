...
extern void    aes_key_schedule_ref (
...
void    aes_128_dec_key_schedule_ref (
    ...
    aes_128_enc_key_schedule_ref(rk, ck);
...
void    aes_192_dec_key_schedule_ref (
    ...
    aes_192_enc_key_schedule_ref(rk, ck);
...
void    aes_256_dec_key_schedule_ref (
    ...
    aes_256_enc_key_schedule_ref(rk, ck);
    aes_dec_key_schedule_inv_mc(rk,ck,AES_256_NR);
}

void    aes_ecb_decrypt_ref (
...
void    aes_128_ecb_decrypt_ref (
    ...
    aes_ecb_decrypt_ref(pt,ct,rk,AES_128_NR);
}
...
void    aes_192_ecb_decrypt_ref (
    ...
    aes_ecb_decrypt_ref(pt,ct,rk,AES_192_NR);
}
...
void    aes_256_ecb_decrypt_ref (
    ...
    aes_ecb_decrypt_ref(pt,ct,rk,AES_256_NR);
}
