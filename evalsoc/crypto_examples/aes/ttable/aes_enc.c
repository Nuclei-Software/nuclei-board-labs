...
void    aes_128_enc_key_schedule_ref (
    ...
    aes_key_schedule_ref(rk, ck, AES_128_NK, AES_128_NR);
}
...
void    aes_192_enc_key_schedule_ref (
    ...
    aes_key_schedule_ref(rk, ck, AES_192_NK, AES_192_NR);
}
...
void    aes_256_enc_key_schedule_ref (
    ...
    aes_key_schedule_ref(rk, ck, AES_256_NK, AES_256_NR);
}


/*!
*/
void    aes_ecb_encrypt_ref (
...
void    aes_128_ecb_encrypt_ref (
    ...
    aes_ecb_encrypt_ref(ct,pt,rk,AES_128_NR);
}
...
void    aes_192_ecb_encrypt_ref (
    ...
    aes_ecb_encrypt_ref(ct,pt,rk,AES_192_NR);
}
...
void    aes_256_ecb_encrypt_ref (
    ...
    aes_ecb_encrypt_ref(ct,pt,rk,AES_256_NR);
}
