...
This is an UART example for RVSTAR board that you can control the RGB LED by inputing 'r', 'g', 'b' in the serial terminal.
...
# cd to this example
cd rvstar/uart/uart_control_led
...
Then you can use a serial terminal tool like Minicom or CoolTerm to connect the board with baudrate 115200. Then every time you input 'r', 'g' or 'b' in the terminal, you will see the RGB LED switch to the related color.
...
Connect RVSTAR board to your PC, build and upload the project and then you can use a serial terminal tool in your IDE or other tools like Minicom or CoolTerm to connect the board with baudrate 115200. Then every time you input 'r', 'g' or 'b' in the terminal, you will see the RGB LED switch to the related color.
